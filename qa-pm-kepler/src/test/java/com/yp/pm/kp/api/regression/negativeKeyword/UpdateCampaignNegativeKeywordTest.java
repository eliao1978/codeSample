...
public class UpdateCampaignNegativeKeywordTest extends BaseAPITest {

    private static Map<String, Object> testData;
    private static Map<String, Object> testData2;
    private Map<String, String> headers = getRequestHeader();

    public String generateNegKeywordString(long campaignId, long negKeywordId, String stat) {
        return " {" +
    ...
    @Test
    public void testUpdateCampaignNegativeKeyword() throws Exception {
    ...
    @Test
    public void testIgnoreUpdateCampaignNegativeKeyword() throws Exception {
    ...
    public void testObjectProblemType() throws Exception {
        ...
        String negKeywordString1 = generateNegKeywordString(campaign.getCampaignId(), negKeyword1.getNegKeywordId(), "ACTIVE");
        String negKeywordString2 = generateNegKeywordString(campaign.getCampaignId(), negKeyword2.getNegKeywordId(), "DELETED");
        String negKeywordString3 = generateNegKeywordString(campaign.getCampaignId(), negKeyword3.getNegKeywordId(), "ACTIVE");

        String payload = "{\"negativeKeywords\" : [" + negKeywordString1 + "," + negKeywordString2 + "," + negKeywordString3 + "], " +
                "\"allowPartialFailure\"";
        headers.put("accountId", ((Account) getTestData().get("account")).getAccountId().toString());
        ResponseDTO responseDTO = getResponseDTO(KeplerDomainTypeEnum.NEGATIVE_KEYWORD, getAPIResponse(MethodEnum.PUT, "account/negative/update", headers, payload));
