...
public class EditCampaignTest extends BaseUITest {

    @Test
    public void testEditCampaignStatus() throws Exception {
        ...
        campaignPage.clickPause();
        assertConditionTrue(campaignPage.getCampaignTableText(2, 2).contains("Paused"));
        ...
        assertObjectEqual(campaign.getCampaignStatus().toString(), CampaignStatusEnum.PAUSED.toString());
    }
}